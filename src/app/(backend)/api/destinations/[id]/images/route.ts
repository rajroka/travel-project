...
// POST /api/destinations/:id/images — add images to a destination
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const destination = await Destination.findByIdAndUpdate(id, updateOps, { new: true });
    if (!destination) {
...
// DELETE /api/destinations/:id/images — remove an image URL
